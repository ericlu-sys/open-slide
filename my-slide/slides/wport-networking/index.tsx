...
const ZH: Content = {
  chip: '人脈經營',
  title: ['在台灣', '怎麼建人脈'],
  sub: 'Building your network in Taiwan',
  tagLeft: '僑外生',
  tagRight: '求職技巧',
  ...
  p2: {
    ...
    list: ['線上先經營', '線下面對面', '持續保持聯繫'],
    fig: '交流活動現場照',
  },
  p3: {
    pill: '從哪裡開始？',
    head: '6 個切入點',
    items: ['LinkedIn', '行業活動', '校友網絡', '就業博覽會', 'Accupass', 'WPORT 聰電站'],
    note: '活動結束後加 LinkedIn，附一句話就好。',
    fig: '人脈網絡示意圖',
  },
  p4: {
    pill: '三個關鍵做法',
    cards: [
      {
        title: 'LinkedIn 要真的互動',
        body: '完整填資料、追蹤業界人士，留有內容的言，不要只按讚。',
      },
      { title: '活動上別急著要工作', body: '先聊你真心有興趣的內容，比一開口就問缺不缺人更自然。' },
      { title: '平時就要保持聯繫', body: '只在找工作時才出現，對方感覺得到，關係也不會長久。' },
    ],
  },
};

const VI: Content = {
  chip: 'Xây dựng quan hệ',
  title: ['Xây quan hệ', 'ở Đài Loan'],
  sub: 'Building your network in Taiwan',
  tagLeft: 'Du học sinh',
  tagRight: 'Bí quyết tìm việc',
  coverFig: 'Ảnh bìa (có thể dùng ảnh blog)',
  p2: {
    pill: 'Vì sao cần quan hệ?',
    head: 'Nhiều việc không lên sàn',
    body: [
      'Tại Đài Loan, một tỷ lệ đáng kể cơ hội việc làm',
      'đến từ người quen giới thiệu hoặc truyền miệng,',
      'chứ không phải qua nền tảng tuyển dụng.',
      'Đây là lý do hiệu quả chênh lệch rất lớn.',
    ],
    list: ['Trực tuyến trước', 'Rồi gặp trực tiếp', 'Giữ liên lạc đều'],
    fig: 'Ảnh sự kiện giao lưu',
  },
  p3: {
    pill: 'Bắt đầu từ đâu?',
    head: '6 điểm tiếp cận',
    items: [
      'LinkedIn',
      'Sự kiện ngành',
      'Mạng cựu sinh viên',
      'Hội chợ việc làm',
      'Accupass',
      'WPORT Charging Station',
    ],
    note: 'Sau sự kiện hãy kết nối LinkedIn kèm một câu ngắn.',
    fig: 'Sơ đồ mạng lưới quan hệ',
  },
  p4: {
    pill: 'Ba cách then chốt',
    cards: [
      {
        title: 'LinkedIn phải tương tác thật',
        body: 'Điền đủ hồ sơ, theo dõi người trong ngành, bình luận có nội dung.',
      },
      {
        title: 'Đừng vội xin việc tại sự kiện',
        body: 'Hãy bắt đầu từ điều bạn thật sự quan tâm; kết nối sẽ tự nhiên hơn.',
      },
      {
        title: 'Giữ liên lạc lúc bình thường',
        body: 'Chỉ xuất hiện khi cần giúp thì đối phương cảm nhận được ngay.',
      },
    ],
  },
};
