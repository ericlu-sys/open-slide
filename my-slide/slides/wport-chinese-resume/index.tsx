...
const ZH: Content = {
  chip: '中文履歷攻略',
  title: ['中文履歷', '怎麼寫？'],
  sub: 'How to write a Taiwanese resume',
  tagLeft: '僑外生',
  tagRight: '求職技巧',
  ...
  p3: {
    ...
    note: '海外學歷可在括號內補充國家說明。',
    fig: '履歷區塊插圖',
  },
  p4: {
    pill: '僑外生要注意',
    cards: [
      { title: '語言能力寫清楚', body: '不要只寫「中文流利」，標明母語程度、日常溝通或商務溝通。' },
      {
        title: '主動說明工作資格',
        body: '在基本資料補一行「具合法工作許可」，不要讓 HR 自己去猜。',
      },
      { title: '學歷認證要標注', body: '海外學歷若已完成教育部認證，在學歷欄旁標注可減少疑慮。' },
    ],
  },
};
...
const VI: Content = {
  chip: 'Hướng dẫn CV',
  title: ['Viết CV tiếng Trung', 'thế nào?'],
  sub: 'How to write a Taiwanese resume',
  tagLeft: 'Du học sinh',
  tagRight: 'Bí quyết tìm việc',
  coverFig: 'Ảnh bìa (có thể dùng ảnh blog)',
  p2: {
    pill: 'Định dạng trước',
    head: '1–2 trang, có ảnh thẻ',
    body: [
      'Định dạng CV chuẩn của Đài Loan là 1–2 trang,',
      'kèm ảnh thẻ nền trắng hoặc nền sáng.',
      'Ảnh thẻ không phải tùy chọn: thiếu ảnh,',
      'nhiều HR thấy CV này chưa hoàn chỉnh.',
    ],
    list: ['Chụp trong 2 năm', 'Ăn mặc gọn gàng', 'Biểu cảm tự nhiên'],
    fig: 'Bố cục CV tiếng Trung',
  },
  p3: {
    pill: 'Cần viết gì?',
    head: 'Bốn phần bắt buộc',
    items: [
      'Họ tên, liên hệ',
      'Nơi ở',
      'Bằng cấp cao nhất',
    ...
    note: 'Bằng cấp nước ngoài nên ghi chú tên nước trong ngoặc.',
    fig: 'Hình các phần của CV',
  },
  p4: {
    pill: 'Du học sinh lưu ý',
    cards: [
      {
        title: 'Nói rõ năng lực ngôn ngữ',
        body: 'Đừng chỉ viết “tiếng Trung lưu loát”. Ghi rõ bản ngữ, hằng ngày hay thương mại.',
      },
      {
        title: 'Chủ động nêu tư cách làm việc',
        body: 'Thêm một dòng “có giấy phép lao động hợp lệ”, đừng để HR phải đoán.',
      },
      {
        title: 'Ghi chú công nhận bằng cấp',
        body: 'Bằng nước ngoài đã được Bộ Giáo dục công nhận thì ghi chú bên cạnh.',
      },
    ],
  },
};
