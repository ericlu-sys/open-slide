...
const Cover: Page = () => (
  ...
  >
    ...
    <h1
      className="tz-fadeup"
      style={{ fontSize: 96, fontWeight: 900, lineHeight: 1.1, margin: 0, letterSpacing: '-.02em' }}
    >
      把四縣市人才資源
      <br />
      串成<span style={{ color: '#7db0ff' }}>同一條科技廊帶人才鏈</span>
    </h1>
    <p
      className="tz-fadeup"
      style={{ fontSize: 38, color: '#c5cdda', marginTop: 34, maxWidth: 1480, lineHeight: 1.5 }}
    >
  ...
  <div style={fillLight}>
    ...
    <Fill gap={24}>
      ...
      >
        ...
        <span style={{ fontSize: 28, color: C.ink, lineHeight: 1.4 }}>
          四縣市已同屬 <b>桃竹苗大矽谷推動方案</b>（行政院／國發會）—
          合作不是另起爐灶，是把人才策略落到青年層級。
        </span>
      </div>
      <div
        style={{
      ...
      >
        <Problem
          ...
          body={
            <>
              桃園設一級<b>青年事務局</b> ↔ 新竹縣<b>無青年專責一級單位</b>，合作對口不對等。
            </>
          }
        />
        <Problem
          ...
          body={
            <>
              安薪需設籍桃園、竹市青創貸需登記竹市 — 青年跨縣市流動就<b>接不上</b>。
            </>
          }
        />
        <Problem
          ...
          body={
            <>
              半導體缺口 3.4 萬、供需比 0.2，但培訓供給仍<b>偏技術本位</b>。
            </>
          }
        />
        <Problem
          ...
          body={
            <>
              竹科「留才」vs 苗栗「返鄉」各說各話；國際／僑外生缺<b>在地落點</b>。
            </>
          }
        />
      </div>
    ...
    <Fill>
      ...
      >
        ...
        <Plan
          ...
          body={
            <>
              育成×青年局×大學產學×企業黑客松，四縣市<b>輪流主辦</b>。
            </>
          }
        />
        <Plan
...
const FirstStep: Page = () => (
  ...
  >
    ...
    <div style={{ flex: 'none' }}>
      ...
      <h2 style={{ fontSize: 70, fontWeight: 900, lineHeight: 1.06, margin: 0 }}>
        不必一步到位，先走出第一步
      </h2>
    </div>
    <Fill gap={30}>
      <div style={{ display: 'flex', gap: 28, flex: 1 }}>
        ...
        >
          <div style={{ fontFamily: C.num, fontSize: 30, fontWeight: 700, color: '#7db0ff' }}>
            半年內
          </div>
          <ul
            style={{
        ...
        >
          <div style={{ fontFamily: C.num, fontSize: 30, fontWeight: 700, color: '#ff9ec4' }}>
            一年內
          </div>
          <ul
            style={{
