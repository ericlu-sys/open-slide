...
const ZH: Content = {
  ...
  p2: {
    ...
    list: ['先定方向', '再大量蒐集', '補外籍友善'],
    fig: '平台比較示意圖',
  },
  p3: {
    pill: '4 大平台',
    head: '各自最適合誰',
    items: ['WPORT', '僑外生專屬', '104', '量大好比較', '1111', '看公司文化', '才多多', '外籍友善'],
    note: '先在 WPORT 定方向，再到 104 廣泛蒐集。',
    fig: '平台 logo 拼貼',
  },
  p4: {
    pill: '三步驟出擊',
    cards: [
      {
        title: '第一步：定位',
        body: '在 WPORT 搞清楚求職方向，把履歷整理成台灣雇主看得懂的格式。',
      },
      { title: '第二步：蒐集', body: '到 104 或 1111 廣泛蒐集職缺，順便摸清這個職位的薪資行情。' },
      { title: '第三步：補強', body: '想鎖定外籍友善企業或跨國職位，同步在才多多補充。' },
    ],
  },
};

const VI: Content = {
  chip: 'So sánh nền tảng',
  title: ['4 nền tảng', 'chọn thế nào?'],
  sub: '4 job platforms compared',
  tagLeft: 'Du học sinh',
  ...
  p2: {
    pill: 'Bắt đầu từ đâu?',
    head: 'Dùng nhiều nền tảng',
    body: [
      'Hệ sinh thái tìm việc ở Đài Loan khác',
      'với môi trường bạn từng quen thuộc.',
      'Không có nền tảng nào là tốt nhất;',
      'phối hợp có chiến lược mới là mấu chốt.',
    ],
    list: ['Định hướng trước', 'Rồi thu thập rộng', 'Bổ sung nơi thân thiện'],
    fig: 'Hình so sánh nền tảng',
  },
  p3: {
    pill: '4 nền tảng',
    head: 'Ai hợp với cái nào',
    items: [
      'WPORT',
      ...
      'Xem văn hóa công ty',
      'Cai DuoDuo',
      'Thân thiện người nước ngoài',
    ],
    note: 'Định hướng ở WPORT trước, rồi sang 104 thu thập.',
    fig: 'Hình logo các nền tảng',
  },
  p4: {
    pill: 'Ba bước xuất phát',
    cards: [
      {
        title: 'Bước 1: Định vị',
        body: 'Trên WPORT, làm rõ hướng tìm việc và chỉnh CV theo định dạng Đài Loan.',
      },
      {
        title: 'Bước 2: Thu thập',
        body: 'Trên 104 hoặc 1111, gom tin tuyển dụng rộng và nắm khoảng lương.',
      },
      {
        title: 'Bước 3: Bổ sung',
        body: 'Muốn công ty thân thiện hoặc vị trí xuyên quốc gia thì thêm Cai DuoDuo.',
      },
    ],
  },
};
