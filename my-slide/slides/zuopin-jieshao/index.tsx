...
const InoueRonin: Page = () => (
  <div style={fill}>
    <WorkPost src={inoueRonin} author="井上雄彥" title="浪人劍客" slug="inoue-ronin" />
  </div>
);

const BauhausArch: Page = () => (
  <div style={fill}>
    <WorkPost src={bauhausArch} author="包浩斯" title="建築" slug="bauhaus-arch" />
  </div>
);

const TogashiSensui: Page = () => (
  <div style={fill}>
    <WorkPost src={togashiSensui} author="富堅義博" title="仙水" slug="togashi-sensui" />
  </div>
);

const OhtsuboVagabond: Page = () => (
  <div style={fill}>
    <WorkPost src={ohtsuboVagabond} author="王欣太" title="達人傳" slug="ohtsubo-vagabond" />
  </div>
);

const PicassoBull: Page = () => (
  <div style={fill}>
    <WorkPost src={picassoBull} author="畢卡索" title="公牛14號" slug="picasso-bull-14" />
  </div>
);

const YeHuji: Page = () => (
  <div style={fill}>
    <WorkPost src={yeHuji} author="葉羽桐" title="胡姬" slug="ye-huji" />
  </div>
);

const ZhengXishi: Page = () => (
  <div style={fill}>
    <WorkPost src={zhengXishi} author="鄭問" title="西施" slug="zheng-xishi" />
  </div>
);
